<template>
    <view class="demo-doc demo-sidebar">
        <van-grid
            ...
            :border="false">
            <van-grid-item>
                <view class="demo-sidebar-title">{{ t('basicUsage') }}</view>
            ...
            <van-grid-item>
                <view class="demo-sidebar-title">{{ t('showBadge') }}</view>
            ...
            <van-grid-item>
                <view class="demo-sidebar-title">{{ t('disabled') }}</view>
            ...
            <van-grid-item>
                <view class="demo-sidebar-title">{{ t('changeEvent') }}</view>
                <van-sidebar
                    v-model="active4"
                    @change="onChange">
