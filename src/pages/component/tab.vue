        ...
        <demo-block
            ...
            <van-tabs v-model:active="activeName">
                <van-tab
                    name="a"
                    :title="t('tab') + 1">
                    <view class="content">{{ t('content') }} 1</view>
                </van-tab>
                <van-tab
                    name="b"
                    :title="t('tab') + 2">
                    <view class="content">{{ t('content') }} 2</view>
                </van-tab>
                <van-tab
                    name="c"
                    :title="t('tab') + 3">
                    <view class="content">{{ t('content') }} 3</view>
                </van-tab>
            </van-tabs>
        </demo-block>
        ...
        <demo-block
            ...
            <van-tabs
                ...
                <van-tab
                    ...
                    :title="t('tab') + index"
                    :key="index">
                    <view class="content !bg-transparent">{{ t('content') }} {{ index }}</view>
                </van-tab>
            </van-tabs>
        </demo-block>
            ...
            <van-tabs v-model:active="active7">
                ...
                <template #a>
                    <view class="flex items-center">
                        <van-image
                            height="14px"
                            :src="cdnURL('user-active.png')"></van-image>
                        <text class="ml-1">自定义</text>
                    </view>
                </template>
                <van-tab
                    name="b"
